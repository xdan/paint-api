...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", { value: true });\nvar tslib_1 = __webpack_require__(/*! tslib */ \"./node_modules/tslib/tslib.es6.js\");\nvar style_1 = __webpack_require__(/*! ./style */ \"./src/core/style.ts\");\nvar helpers_1 = __webpack_require__(/*! ./helpers/ */ \"./src/core/helpers/index.ts\");\nvar const_1 = __webpack_require__(/*! ../const */ \"./src/const.ts\");\nvar ucfirst_1 = __webpack_require__(/*! ./helpers/ucfirst */ \"./src/core/helpers/ucfirst.ts\");\nvar Manager = /** @class */ (function () {\n    function Manager(shape) {\n        this.shape = shape;\n        this.styles = {\n            round: new style_1.Style({\n                fillColor: '#0d80ff',\n                dash: [],\n                color: '#005d7f'\n            }),\n            line: new style_1.Style({\n                fillColor: '#0d80ff',\n                opacity: 0.3,\n                dash: [5, 1],\n                color: '#005d7f'\n            }),\n            active: new style_1.Style({\n                fillColor: '#00b8ff',\n                dash: [5, 1],\n                color: '#cccccc'\n            })\n        };\n    }\n    Manager.prototype.getBoundLines = function (bound) {\n        return [\n            [\n                { x: bound.x + const_1.HANDLE_RADIUS, y: bound.y },\n                { x: bound.x + bound.w - const_1.HANDLE_RADIUS, y: bound.y }\n            ],\n            [\n                { x: bound.x + bound.w, y: bound.y + const_1.HANDLE_RADIUS },\n                { x: bound.x + bound.w, y: bound.y + bound.h - const_1.HANDLE_RADIUS }\n            ],\n            [\n                { x: bound.x + const_1.HANDLE_RADIUS, y: bound.y + bound.h },\n                { x: bound.x + bound.w - const_1.HANDLE_RADIUS, y: bound.y + bound.h }\n            ],\n            [\n                { x: bound.x, y: bound.y + const_1.HANDLE_RADIUS },\n                { x: bound.x, y: bound.y + bound.h - const_1.HANDLE_RADIUS }\n            ]\n        ];\n    };\n    Manager.prototype.getCorners = function (bound) {\n        return [\n            {\n                x: bound.x,\n                y: bound.y,\n                r: const_1.HANDLE_RADIUS\n            },\n            {\n                x: bound.x + bound.w,\n                y: bound.y,\n                r: const_1.HANDLE_RADIUS\n            },\n            {\n                x: bound.x + bound.w,\n                y: bound.y + bound.h,\n                r: const_1.HANDLE_RADIUS\n            },\n            {\n                x: bound.x,\n                y: bound.y + bound.h,\n                r: const_1.HANDLE_RADIUS\n            }\n        ];\n    };\n    Manager.prototype.draw = function (render, cursor) {\n        var _this = this;\n        render.setStyle(this.styles.line);\n        var bound = this.shape.bound;\n        var lines = this.getBoundLines(bound);\n        lines.forEach(function (line) {\n            render.setStyle(helpers_1.isOnLine(cursor, line) ? _this.styles.active : _this.styles.line);\n            render.drawLine(line[0], line[1]);\n        });\n        var corners = this.getCorners(bound);\n        corners.forEach(function (corner) {\n            render.setStyle(helpers_1.isInRound(cursor, corner)\n                ? _this.styles.active\n                : _this.styles.round);\n            render.drawCircle(corner, true);\n        });\n        render.resetStyle();\n    };\n    Manager.prototype.fire = function (eventName, e) {\n        var bound = this.shape.bound;\n        var lines = this.getBoundLines(bound), type = ucfirst_1.ucfirst(eventName.toString()), es = tslib_1.__assign({}, e, { shape: this.shape });\n        e.api.events.fire('shape' + type, es);\n        lines.forEach(function (line) {\n            if (helpers_1.isOnLine(e, line)) {\n                e.api.events.fire('border' + type, es, line);\n            }\n        });\n        var corners = this.getCorners(bound);\n        corners.forEach(function (corner) {\n            if (helpers_1.isInRound(e, corner)) {\n                e.api.events.fire('corner' + type, tslib_1.__assign({}, es, { corner: corner }));\n            }\n        });\n    };\n    return Manager;\n}());\nexports.Manager = Manager;\n\n\n//# sourceURL=webpack:///./src/core/manager.ts?");
...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", { value: true });\nvar rgb_1 = __webpack_require__(/*! ./rgb */ \"./src/core/rgb.ts\");\nvar Style = /** @class */ (function () {\n    function Style(raw) {\n        var _this = this;\n        this.color = new rgb_1.RGB();\n        this.fillColor = new rgb_1.RGB();\n        this.opacity = 0;\n        this.strokeWidth = 1;\n        this.lineCap = 'round';\n        this.dash = [];\n        if (raw) {\n            Object.keys(raw).forEach(function (key) {\n                var value = raw[key];\n                if (value !== undefined) {\n                    switch (key) {\n                        case 'fillColor':\n                        case 'color':\n                            _this[key].hex = value.toString();\n                            break;\n                        default:\n                            _this[key] = raw[key];\n                    }\n                }\n            });\n        }\n    }\n    return Style;\n}());\nexports.Style = Style;\n\n\n//# sourceURL=webpack:///./src/core/style.ts?");
